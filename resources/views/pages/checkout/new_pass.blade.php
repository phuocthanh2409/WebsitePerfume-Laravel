          ...
          <form role="form" method="POST" action="{{url('/reset-new-pass')}}">
           ...
           <fieldset>							
             <div class="form-group">
               ...
               <input type="text" style="width: 30%" name="password_account" class="form-control input-lg @error('password_account') is-invalid @enderror" placeholder="Nhập mật khẩu mới">
