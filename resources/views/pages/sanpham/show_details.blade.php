            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <ul id="imageGallery">
                        ...
                        <li data-thumb="{{asset('public/uploads/gallery/'.$gal->galleryHinhAnh)}}"
                            data-src="{{asset('public/uploads/gallery/'.$gal->galleryHinhAnh)}}">
                ...
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <form method="POST">
                            ...
                            <input type="hidden" value="{{$value->spHinhAnh}}"
                                class="cart_product_image_{{$value->spMa}}">
                            <input type="hidden" value="{{$value->spSoLuong}}"
                                class="cart_product_quantity_{{$value->spMa}}">
                            <input type="hidden" value="{{$value->spGia}}" class="cart_product_price_{{$value->spMa}}">
                            <div class="product__details__cart__option">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <input class="cart_product_qty_{{$value->spMa}}" name="qty" type="number"
                                            min="1" name="soluongsanpham" value="1">
                                    </div>
                                </div>
                                @if ($value->spSoLuong == 0)
                                <input style="background: grey;" type="button" disabled class="primary-btn add-to-cart" data-id_product="{{$value->spMa}}"
                                name="add-to-cart" value="Sản phẩm hết hàng">
                                @else
                                <input type="button" class="primary-btn add-to-cart" data-id_product="{{$value->spMa}}"
                                    name="add-to-cart" value="Thêm vào giỏ hàng">
                                @endif
                            </div>
                                ...
                                <div class="product__details__tab__content">
                                    <div class="product__details__tab__content__item">
                                        <div class="card">
                                            <div class="card-body">
                                                <form>
                                                    ...
                                                    <input type="hidden" name="comment_product_id"
                                                        class="comment_product_id" value="{{$value->spMa}}">
                                                    <div id="comment_show">
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <form class="form-block" style="margin: 0 50px; padding-bottom: 30px;">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12">
                                                        <div class="form-group fl_icon">
                                                            ...
                                                            <input class="form-input comment-name" type="text"
                                                                placeholder="Tên của bạn">
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-12" style="width: 100%; margin: 0 15px;">
                                                        <div class="form-group">
                                                            <textarea class="form-input comment-content" name="comment"
                                                                required=""
                                                                placeholder="Bình luận của bạn về sản phẩm"></textarea>
                                                        </div>
                                                    </div>
                                                    <button class="btn btn-primary pull-right send-comment"
                                                        type="button" style="color: white; margin-left: 15px;">Gửi bình
                                                        luận</button>
                                                </div>
                                            </form>
                                        </div>
                ...
                <div class="product__item">
                    <a href="{{URL::to('/chi-tiet-san-pham/'.$rlsp->spMa)}}">
                        <div class="product__item__pic set-bg"
                            data-setbg="{{URL::to('public/uploads/product/'.$rlsp->spHinhAnh)}}">
                        </div>
                    </a>
                    <div class="product__item__text">
                        <form>
                            ...
                            <input type="hidden" value="{{$rlsp->spHinhAnh}}"
                                class="cart_product_image_{{$rlsp->spMa}}">
                            <input type="hidden" value="{{$rlsp->spGia}}" class="cart_product_price_{{$rlsp->spMa}}">
                            <input type="hidden" value="{{$rlsp->spSoLuong}}"
                                class="cart_product_quantity_{{$rlsp->spMa}}">
                            <input type="hidden" value="1" class="cart_product_qty_{{$rlsp->spMa}}">
                            <div class="product__item__text">
                                <h6>{{$rlsp->spTen}}</h6>
                                <button style="padding: 0;
                          border: none;
                          background: none;" type="button" class="add-to-cart" data-id_product="{{$rlsp->spMa}}"
                                    name="add-to-cart">
                                    <a class="add-cart">
                                        + Thêm vào giỏ hàng
                                    </a>
