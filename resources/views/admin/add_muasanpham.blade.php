        ...
        <form action="{{URL::to('/save-muasanpham')}}" method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control @error('muaTen') is-invalid @enderror" id="inputText3" type="text" placeholder="Tên mùa sản phẩm" name="muaTen">
              @error('muaTen')
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control @error('muasanpham_mota') is-invalid @enderror"  placeholder="Mô tả mùa sản phẩm" name="muasanpham_mota"></textarea>
              @error('muasanpham_mota')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
          </div>
