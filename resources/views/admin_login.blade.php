        ...
        @endif
                <form action="{{URL::to('/admin-dashboard')}}" method="POST">
                  ...
                  <div class="form-group">
                    <input class="form-control @error('qtEmail') is-invalid @enderror" id="username" type="email" name="qtEmail" placeholder="Địa chỉ email" autocomplete="off">
                    @error('qtEmail')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="form-group">
                    <input class="form-control @error('qtMatKhau') is-invalid @enderror" id="password" type="password" name="qtMatKhau" placeholder="Mật khẩu">
                    @error('qtMatKhau')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
