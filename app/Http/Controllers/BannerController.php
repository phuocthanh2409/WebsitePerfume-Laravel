...
class BannerController extends Controller
{
    ...
    public function insert_banner(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'slider_ten.max' =>  'Tên banner quá dài. Vui lòng kiểm tra lại',
                'slider_mota.required' => 'Vui lòng nhập nội dung banner',
                'slider_hinhanh.required' => 'Vui lòng chọn hình ảnh banner',
    ...
    public function update_banner(Request $request, $sliderMa)
    {
        ...
        $request->validate(
            [
                'banner_ten' => 'required|max:191',
                'banner_hinhanh' => 'image|mimes:jpeg,png,svg|max:2048',
                'banner_mota' => 'required'
            ],
            [
                'banner_ten.required' =>  'Vui lòng nhập tên banner',
                'banner_ten.max' =>  'Tên banner quá dài. Vui lòng kiểm tra lại',
                'banner_mota.required' => 'Vui lòng nhập nội dung banner',
                'banner_hinhanh.mimes' => 'File không phải là hình ảnh. Vui lòng kiểm tra lại',
                'banner_hinhanh.max' => 'File hình ảnh quá lớn. Vui lòng chọn hình ảnh dưới 2mb'
            ]
        );
        $data = array();
