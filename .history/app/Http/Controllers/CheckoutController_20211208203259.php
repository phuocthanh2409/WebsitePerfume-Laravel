...
class CheckoutController extends Controller
{
    ...
    {
        $data = array();
        $data['dhTen'] = $request->dhTen;
        $data['dhSoDienThoai'] = $request->dhSoDienThoai;
        $data['dhEmail'] = $request->dhEmail;
        $data['dhDiaChi'] = $request->dhDiaChi;
        $data['dhGhiChu'] = $request->dhGhiChu;

        $customer_id = DB::table('donhang')->insertGetId($data);
