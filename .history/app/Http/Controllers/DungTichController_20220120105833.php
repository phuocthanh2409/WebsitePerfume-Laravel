...
class DungTichController extends Controller
{
    ...
    public function save_dungtich(Request $request)
    {
        ...
        $request->validate(
            [
                'dtTen' => 'required|unique:thuonghieu|max:191',
                'dungtich_mota' => 'required|max:191'
            ],
            [
                'dtTen.required' =>  'Vui lòng nhập tên thương hiệu sản phẩm',
                'dtTen.max' =>  'Tên thương hiệu sản phẩm quá dài. Vui lòng kiểm tra lại',
                'dtTen.unique' =>  'Tên thương hiệu sản phẩm đã bị trùng. Vui lòng kiểm tra lại',
                'dungtich_mota.required' => 'Vui lòng nhập mô tả thương hiệu sản phẩm',
