...
class KhachHangController extends Controller
{
    ...
    public function save_thongtin(Request $request)
    {
        ...
        if ($makhachhang) {
            ...
            Session::put('khSoDienThoai', $thongtin->khTen);
            return view('pages.khachhang.tai_khoan')->with('loaisanpham', $loaisanpham)->with('thuonghieu', $thuonghieu)->with('muasanpham', $muasanpham)->with('success', 'Cập nhật thông tin tài khoản thành công');
        }
    }
}
