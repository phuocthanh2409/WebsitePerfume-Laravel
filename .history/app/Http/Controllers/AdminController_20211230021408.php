...
class AdminController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        $request->validate(
            ...
            [
                'qtEmail.required' =>  'Vui lòng nhập tên người nhận hàng',
                'qtMatKhau.required' => 'Vui lòng nhập email người nhận hàng',
                'qtEmail.max' => 'Tên người nhận hàng quá dài. Vui lòng kiểm tra lại',
                'qtMatKhau.max' => 'Email người nhận hàng quá dài. Vui lòng kiểm tra lại',
                'qtEmail.email' => 'Email người nhận hàng không đúng định dạng. Vui lòng kiểm tra lại'
            ]
        );
