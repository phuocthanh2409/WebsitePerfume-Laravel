...
class SanPhamController extends Controller
{
    ...
    public function save_sanpham(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'sanpham_ten.required' =>  'Vui lòng nhập thông tin liên hệ',
                'sanpham_gia.required' => 'Vui lòng nhập thông tin bản đồ',
                'sanpham_giagoc.required' => 'Vui lòng nhập thông tin fanpage Facebook',
                'sanpham_mota.required' => 'Vui lòng chọn hình ảnh logo cửa hàng',
                'sanpham_soluong.required' => 'Vui lòng chọn hình ảnh logo cửa hàng',
                'sanpham_soluong.required' => 'Thông tin cửa hàng quá dài. Vui lòng kiểm tra lại',
