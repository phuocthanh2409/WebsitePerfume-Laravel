...
class CheckoutController extends Controller
{
    ...
    public function confirm_order(Request $request)
    {
        ...
        $shipping->shippingEmail = $data['shippingTen'];
        $shipping->shippingDiaChi = $data['shippingTen'];
        $shipping->shippingSoDienThoai = $data['shippingTen'];
        $shipping->shippingGhiChu = $data['shippingTen'];
        $shipping->shippingPhuongThuc = $data['shippingTen'];
    }
}
