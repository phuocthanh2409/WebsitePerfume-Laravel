...
class MuaSanPham extends Controller
{
    ...
    public function show_mua_home($muaMa)
    {
        ...
        return view('pages.muasanpham.show_muasanpham')->with('loaisanpham', $loaisanpham)->with('thuonghieu', $thuonghieu)->with('muasanpham', $muasanpham)->with('mua_by_id', $mua_by_id)->with('mua_name', $mua_by_id);
    }
}
