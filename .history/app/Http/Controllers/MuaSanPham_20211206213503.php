...
class MuaSanPham extends Controller
{
    ...
    public function show_mua_home($muaMa)
    {
        ...
        $mua_name = DB::table('muasanpham')->where('muasanpham.muaMa', $thMa)->limit(1)->get();
        return view('pages.muasanpham.show_muasanpham')->with('loaisanpham', $loaisanpham)->with('thuonghieu', $thuonghieu)->with('muasanpham', $muasanpham)->with('mua_by_id', $mua_by_id);
    }
}
