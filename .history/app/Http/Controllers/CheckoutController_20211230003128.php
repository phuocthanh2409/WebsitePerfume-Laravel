    ...
    public function confirm_order(Request $request)
    {
        $request->validate(
            [
                ...
                'shippingSoDienThoai' => 'required|max:191',
                'shippingGhiChu' => 'nullable|max:191',
            ],
            [
                'shippingTen.required' =>  'Vui lòng nhập email để đăng nhập',
                'shippingEmail.required' => 'Vui lòng nhập mật khẩu để đăng nhập',
                ...
                'shippingGhiChu.required' => 'Vui lòng nhập mật khẩu để đăng nhập',
                'khEmail.max' => 'Email của bạn quá dài. Vui lòng kiểm tra lại',
                'khMatKhau.max' => 'Mật khẩu của bạn quá dài. Vui lòng kiểm tra lại',
                'khEmail.email' => 'Email của bạn không đúng định dạng. Vui lòng kiểm tra lại',
            ]
