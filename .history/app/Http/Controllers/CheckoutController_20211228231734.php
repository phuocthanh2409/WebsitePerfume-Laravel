    ...
    public function add_customer(Request $request)
    {
        $request->validate(
            [
                ...
                'khSoDienThoai' => 'required|numeric|min:10|max:10'
            ],
            [
                'khTen.required' =>  'Vui lòng nhập tên khách hàng để đăng kí',
                'khEmail.required' => 'Vui lòng nhập email khách hàng để đăng kí',
                'khMatKhau.required' => 'Vui lòng nhập mật khẩu khách hàng để đăng kí',
                ...
                'khSoDienThoai.numeric' => 'Số điện thoại phải là kiểu số. Vui lòng kiểm tra lại',
                'khSoDienThoai.min' => 'Số điện thoại phải có ít nhất 10 số. Vui lòng kiểm tra lại',
                'khSoDienThoai.max' => 'Số điện thoại phải có nhiều nhất 10 số. Vui lòng kiểm tra lại'
            ]
        );
        $now = Carbon::now('Asia/Ho_Chi_Minh')->format('d-m-Y');
        $title_mail = "Đăng ký tài khoản cửa hàng nước hoa The Perfume" . ' ' . $now;

        if (KhachHang::where('khEmail', '=', $request->khEmaildk)->exists()) {
