...
class SanPhamController extends Controller
{
    ...
    public function save_sanpham(Request $request)
    {
        ...
        $request->validate(
            [
                'sanpham_ten' => 'required|unique:sanpham|max:191',
                'sanpham_gia' => 'required|max:191|min:1|alpha_num|not_in:0',
                'sanpham_giagoc' => 'required|max:191|min:1|numeric|not_in:0',
                'sanpham_mota' => 'required',
                'sanpham_soluong' => 'required|max:191|min:1|numeric|not_in:0',
                'sanpham_hinhanh' => 'required|image|mimes:jpeg,png,svg|max:2048'
            ],
            [
                'sanpham_ten.required' =>  'Vui lòng nhập tên sản phẩm',
                'sanpham_ten.max' =>  'Tên sản phẩm quá dài. Vui lòng kiểm tra lại',
                'sanpham_ten.unique' =>  'Tên sản phẩm đã bị trùng. Vui lòng kiểm tra lại',
                'sanpham_gia.required' => 'Vui lòng nhập giá sản phẩm',
                'sanpham_gia.alpha_num' => 'Vui lòng nhập giá lớn hơn 0',
                'sanpham_gia.max' => 'Giá sản phẩm quá dài. Vui lòng kiểm tra lại',
                'sanpham_giagoc.required' => 'Vui lòng nhập giá gốc sản phẩm',
                'sanpham_giagoc.max' => 'Giá gốc sản phẩm quá dài. Vui lòng kiểm tra lại',
                'sanpham_mota.required' => 'Vui lòng nhập mô tả sản phẩm',
                'sanpham_soluong.required' => 'Vui lòng nhập số lượng sản phẩm',
                'sanpham_soluong.max' => 'Số lượng sản phẩm quá dài. Vui lòng kiểm tra lại',
        ...
        $data = array();
        $product_price = filter_var($request->sanpham_gia, FILTER_SANITIZE_NUMBER_INT);
        $product_cost = filter_var($request->sanpham_giagoc, FILTER_SANITIZE_NUMBER_INT);
        $data['spTen'] = $request->sanpham_ten;
        $data['spGia'] = $product_price;
        $data['spGiaGoc'] = $product_cost;
    ...
    public function update_sanpham(Request $request, $spMa)
    {
        $request->validate(
            [
                'sanpham_ten' => 'required|max:191',
                'sanpham_gia' => 'required|max:191',
                'sanpham_giagoc' => 'required|max:191',
                'sanpham_mota' => 'required',
                'sanpham_soluong' => 'required|max:191',
