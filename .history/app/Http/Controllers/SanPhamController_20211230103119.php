...
class SanPhamController extends Controller
{
    ...
    public function save_sanpham(Request $request)
    {
        ...
        $request->validate(
            [
                'sanpham_ten' => 'required|unique:sanpham|max:1000',
                'sanpham_gia' => 'required|max:1000',
                'sanpham_giagoc' => 'required|max:1000',
                'sanpham_mota' => 'required|image|mimes:jpeg,png,svg|max:2048',
                'sanpham_soluong' => 'required|max:1000',
                'sanpham_hinhanh' => 'required|max:1000',
            ],
            [
