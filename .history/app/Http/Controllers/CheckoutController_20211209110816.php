...
class CheckoutController extends Controller
{
    ...
    public function order_place(Request $request)
    {
        ...
        $order_d_data = array();
        $order_d_data['khMa'] = Session::get('khMa');
        $order_d_data['shippingMa'] = Session::get('shippingMa');
        $order_d_data['paymentMa'] = $payment_id;
        $order_d_data['dhTongTien'] = Session::get('dhTongTien');
        $order_d_data['dhTrangThai'] = "Đang chờ xử lý";
        $order_id = DB::talbe('donhang')->insertGetId($order_data);
    }
}
