...
class KhachHangController extends Controller
{
    ...
    public function save_thongtin(Request $request)
    {
        $request->validate(
            ...
            [
                'tenkhachhang.required' =>  'Vui lòng nhập tên người nhận hàng',
                'sodienthoaikhachhang.required' => 'Vui lòng nhập số điện thoại người nhận hàng',
                'tenkhachhang.max' => 'Tên người nhận hàng quá dài. Vui lòng kiểm tra lại',
                'sodienthoaikhachhang.size' => 'Số điện thoại bao gồm 10 số. Vui lòng kiểm tra lại'
            ]
        );
