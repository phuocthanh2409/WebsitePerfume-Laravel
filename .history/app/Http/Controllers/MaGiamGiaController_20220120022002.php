...
class MaGiamGiaController extends Controller
{
    ...
    public function update_magiamgia(Request $request, $mggMa)
    {
        ...
        $request->validate(
            [
                'magiamgia_Ten' => 'required|max:191|unique:magiamgia',
            ...
            [
                ...
                'magiamgia_Ten.unique' =>  'Tên mã giảm giá đã bị trùng. Vui lòng kiểm tra lại',
                ...
                'magiamgia_SoLuong.required' => 'Vui lòng nhập giá sản phẩm',
                'magiamgia_SoLuong.min' => 'Vui lòng nhập giá sản phẩm lớn hơn 1',
                'magiamgia_SoLuong.numeric' => 'Vui lòng nhập giá sản phẩm là kiểu số',
                'magiamgia_GiaTri.required' => 'Vui lòng nhập giá gốc sản phẩm',
                'magiamgia_GiaTri.min' => 'Vui lòng nhập giá gốc sản phẩm lớn hơn 1',
                'magiamgia_GiaTri.numeric' => 'Vui lòng nhập giá gốc sản phẩm là kiểu số'
            ]
        );
        $data = $request->all();
