...
class KhachHangController extends Controller
{
    ...
    public function save_thongtin(Request $request)
    {
        ...
        if ($makhachhang) {
            ...
            return Redirect::to('tai_khoan')->with('loaisanpham', $loaisanpham)->with('thuonghieu', $thuonghieu)->with('muasanpham', $muasanpham)->with('success', 'Cập nhật thông tin tài khoản thành công');
        }
    }
}
