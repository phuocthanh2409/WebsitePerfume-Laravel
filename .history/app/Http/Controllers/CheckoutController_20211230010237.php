...
class CheckoutController extends Controller
{
    ...
    public function confirm_order(Request $request)
    {
        ...
        return view('pages.history.history')->with('loaisanpham', $loaisanpham)->with('thuonghieu', $thuonghieu)->with('muasanpham', $muasanpham)->with('donhang', $order)->with('success', 'Bạn đã đặt hàng thành công');
    }
}
