...
class AdminController extends Controller
{
    ...
    public function save_matkhauquantri(Request $request)
    {
        $request->validate(
            ...
            [
                'quantrimatkhaucu.required' =>  'Vui lòng nhập mật khẩu hiện tại của khách hàng',
                'quantrimatkhaumoi.required' => 'Vui lòng nhập mật khẩu khách hàng muốn đổi',
                'quantrimatkhaucu.max' => 'Mật khẩu hiện tại của khách hàng quá dài. Vui lòng kiểm tra lại',
                'quantrimatkhaumoi.max' => 'Mật khẩu khách hàng muốn đổi quá dài. Vui lòng kiểm tra lại'
            ]
        );
