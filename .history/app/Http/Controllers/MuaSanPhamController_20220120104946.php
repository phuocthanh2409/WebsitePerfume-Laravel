...
class MuaSanPhamController extends Controller
{
    ...
    public function save_muasanpham(Request $request)
    {
        ...
        $request->validate(
            [
                'muaTen' => 'required|unique:muasanpham|max:191',
                'muasanpham_mota' => 'required|max:191'
            ],
            [
                'muaTen.required' =>  'Vui lòng nhập tên thương hiệu sản phẩm',
                'muaTen.max' =>  'Tên thương hiệu sản phẩm quá dài. Vui lòng kiểm tra lại',
                'muaTen.unique' =>  'Tên thương hiệu sản phẩm đã bị trùng. Vui lòng kiểm tra lại',
                'muasanpham_mota.required' => 'Vui lòng nhập mô tả thương hiệu sản phẩm',
                'muasanpham_mota.max' => 'Mô tả thương hiệu sản phẩm quá dài. Vui lòng kiểm tra lại'
            ]
        );
        $data = $request->all();
