    ...
    public function save_sanpham(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'sanpham_ten.max' =>  'Tên sản phẩmm quá dài. Vui lòng kiểm tra lại',
                'sanpham_gia.required' => 'Vui lòng nhập giá sản phẩm',
                'sanpham_gia.max' => 'Tên sản phẩmm quá dài. Vui lòng kiểm tra lại',
                'sanpham_giagoc.required' => 'Vui lòng nhập giá gốc sản phẩm',
                'sanpham_giagoc.max' => 'Vui lòng nhập giá gốc sản phẩm',
