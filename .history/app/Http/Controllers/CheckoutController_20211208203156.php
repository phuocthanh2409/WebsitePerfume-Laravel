...
class CheckoutController extends Controller
{
    ...
    {
        $data = array();
        $data['dhTen'] = $request->khTen;
        $data['dhSoDienThoai'] = $request->khEmail;
        $data['dhEmail'] = $request->khMatKhau;
        $data['dhDiaChi'] = $request->khSoDienThoai;
        $data['dhGhiChu'] = $request->khSoDienThoai;
