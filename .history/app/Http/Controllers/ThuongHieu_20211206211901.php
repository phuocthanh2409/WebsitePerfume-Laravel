...
class ThuongHieu extends Controller
{
    ...
    public function show_thuonghieu_home($thMa)
    {
        ...
        $thuonghieu_by_id = DB::table('sanpham')
            ...
            ->get();
        return view('pages.thuonghieu.show_thuonghieu')->with('loaisanpham', $loaisanpham)->with('thuonghieu', $thuonghieu)->with('muasanpham', $muasanpham)->with('loaisanpham_by_id', $loaisanpham_by_id);
    }
}
