...
class CheckoutController extends Controller
{
    ...
    public function add_customer(Request $request)
    {
        $request->validate(
            ...
            [
                'khTen.required' =>  'Vui lòng nhập email để đăng nhập',
                'khEmail.required' => 'Vui lòng nhập mật khẩu để đăng nhập',
                'khMatKhau.required' => 'Vui lòng nhập mật khẩu để đăng nhập',
                'khSoDienThoai.required' => 'Vui lòng nhập mật khẩu để đăng nhập',
