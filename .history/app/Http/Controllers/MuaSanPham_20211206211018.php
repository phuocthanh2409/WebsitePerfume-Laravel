...
class MuaSanPham extends Controller
{
    ...
    public function show_mua_home($muaMa)
    {
        ...
        $mua_by_id = DB::table('sanpham')
            ...
            ->get();
        return view('pages.muasanpham.show_muasanpham')->with('loaisanpham', $loaisanpham)->with('thuonghieu', $thuonghieu)->with('muasanpham', $muasanpham)->with('loaisanpham_by_id', $loaisanpham_by_id);
    }
}
