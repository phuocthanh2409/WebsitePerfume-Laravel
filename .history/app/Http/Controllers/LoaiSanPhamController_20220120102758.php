...
class LoaiSanPhamController extends Controller
{
    ...
    public function save_loaisanpham(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'loaiTen.required' =>  'Vui lòng nhập tên sản phẩm',
                'loaiTen.max' =>  'Tên sản phẩm quá dài. Vui lòng kiểm tra lại',
                'loaiTen.unique' =>  'Tên sản phẩm đã bị trùng. Vui lòng kiểm tra lại',
                'loaisanpham_mota.required' => 'Vui lòng nhập giá sản phẩm',
                'loaisanpham_mota.max' => 'Vui lòng nhập giá sản phẩm lớn hơn 1'
            ]
        );
        $data = $request->all();
