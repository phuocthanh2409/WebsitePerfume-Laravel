    ...
    public function insert_delivery(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'phivanchuyen.required' => 'Vui lòng nhập mô tả loại sản phẩm',
                'phivanchuyen.max' => 'Mô tả loại sản phẩm quá dài. Vui lòng kiểm tra lại'
            ]
        );
        $data = $request->all();
