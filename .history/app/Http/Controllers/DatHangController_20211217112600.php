...
class DatHangController extends Controller
{
    ...
    {
        if (!Session::get('khMa')) {
            return redirect('login-checkout')->with('message', 'Vui lòng đăng nhập để xem lịch sử đơn hàng');
        } else {
    ...
    public function view_history_donhang(Request $request)
    {
        if (!Session::get('khMa')) {
            return redirect('login-checkout')->with('message', 'Vui lòng đăng nhập để xem lịch sử đơn hàng');
        } else {
            ...
            return view('pages.history.view_history_order')->with(compact('order', 'loaisanpham', 'thuonghieu', 'muasanpham'));
        }
    }
}
