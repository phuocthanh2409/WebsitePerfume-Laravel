...
class AdminController extends Controller
{
    ...
    public function save_adminthongtin(Request $request)
    {
        $request->validate(
            ...
            [
                'quantriten.required' =>  'Vui lòng nhập tên khách hàng',
                'quantrisdt.required' => 'Vui lòng nhập số điện thoại khách hàng',
                'quantriten.max' => 'Tên khách hàng quá dài. Vui lòng kiểm tra lại',
                'quantrisdt.size' => 'Số điện thoại khách bao gồm 10 số. Vui lòng kiểm tra lại'
            ]
        );
