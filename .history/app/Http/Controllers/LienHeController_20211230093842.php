...
class LienHeController extends Controller
{
    ...
    public function save_info(Request $request)
    {
        $request->validate(
            [
                'info_contact' => 'required|max:191',
                'info_map' => 'required|max:191|email:rfc,dns,strict,spoof,filter',
                'info_fanpage' => 'required|max:191',
                'info_image' => 'required|image|mimes:jpeg,png,svg|max:2048'
            ],
            [
                'info_contact.required' =>  'Vui lòng nhập thông tin liên hệ',
                'info_map.required' => 'Vui lòng nhập email khách hàng để đăng kí',
                'info_fanpage.required' => 'Vui lòng nhập mật khẩu khách hàng để đăng kí',
                'info_image.required' => 'Vui lòng nhập số điện thoại khách hàng để đăng kí',
