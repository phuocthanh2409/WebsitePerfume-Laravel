...
class MailController extends Controller
{
    ...
    public function recover_pass(Request $request)
    {
        ...
        if ($customer) {
            ...
            if ($count_customer == 0) {
                ...
                return redirect()->back()->with('message', 'Chúng tôi đã gửi link khôi phục mật khẩu vào email của bạn. Vui lòng vào email để thực hiện khôi phục mật khẩu');
            }
        }
    }
    ...
    public function reset_new_pass(Request $request)
    {
        ...
        if ($count > 0) {
            ...
            $reset->save();
            return redirect('login-checkout')->with('message', 'Mật khẩu của bạn đã đươc cập nhật');
        } else {
