    ...
    public function save_dungtich(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                ...
                'dungtich_mota.required' => 'Vui lòng nhập mô tả dung tích sản phẩm',
                'dungtich_mota.max' => 'Mô tả dung tích sản phẩm quá dài. Vui lòng kiểm tra lại'
            ]
        );
        $data = array();
