...
class AdminController extends Controller
{
    ...
    public function save_matkhauquantri(Request $request)
    {
        $request->validate(
            [
                'matkhaucu' => 'required|max:191',
                'matkhaumoi' => 'required|max:191'
            ],
            [
                'matkhaucu.required' =>  'Vui lòng nhập mật khẩu hiện tại của khách hàng',
                'matkhaumoi.required' => 'Vui lòng nhập mật khẩu khách hàng muốn đổi',
                'matkhaucu.max' => 'Mật khẩu hiện tại của khách hàng quá dài. Vui lòng kiểm tra lại',
                'matkhaumoi.max' => 'Mật khẩu khách hàng muốn đổi quá dài. Vui lòng kiểm tra lại'
            ]
        );
