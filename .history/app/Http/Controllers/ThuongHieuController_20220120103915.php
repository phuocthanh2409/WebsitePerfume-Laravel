...
class ThuongHieuController extends Controller
{
    ...
    public function save_thuonghieu(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'thTen.required' =>  'Vui lòng nhập tên loại sản phẩm',
                'thTen.max' =>  'Tên loại sản phẩm quá dài. Vui lòng kiểm tra lại',
                'thTen.unique' =>  'Tên loại sản phẩm đã bị trùng. Vui lòng kiểm tra lại',
                'thuonghieu_mota.required' => 'Vui lòng nhập mô tả loại sản phẩm',
                'thuonghieu_mota.max' => 'Mô tả loại sản phẩm quá dài. Vui lòng kiểm tra lại'
            ]
        );
        $data = $request->all();
