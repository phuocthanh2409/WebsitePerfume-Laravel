...
Route::get('/logo', 'App\Http\Controllers\LienHeController@logo');
...
Route::get('/admin-thongtin', 'App\Http\Controllers\AdminController@admin_thongtin');
Route::post('/save-adminthongtin', 'App\Http\Controllers\AdminController@save_adminthongtin');
Route::get('/doimatkhau-quantri', 'App\Http\Controllers\AdminController@doimatkhau_quantri');
Route::post('/save-matkhauquantri', 'App\Http\Controllers\AdminController@save_matkhauquantri');
...
//Tai khoan
Route::get('/tai-khoan', 'App\Http\Controllers\KhachHangController@tai_khoan');
Route::post('/save-thongtin', 'App\Http\Controllers\KhachHangController@save_thongtin');
Route::get('/doi-mat-khau', 'App\Http\Controllers\KhachHangController@doi_mat_khau');
Route::post('/save-matkhau', 'App\Http\Controllers\KhachHangController@save_matkhau');
