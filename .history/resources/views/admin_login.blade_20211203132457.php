            ...
            <div class="card card-border-color card-border-color-primary">
              ...
              <div class="card-body">
                ...
                <?php 
                    ...
                    if($message){
                        echo '<div class="alert alert-danger alert-simple alert-dismissible" style="border: none;-webkit-box-shadow: none; box-shadow: none; font-size: 15px; ">',$message.'</div>';
                ...
                <form action="{{URL::to('/admin-dashboard')}}" method="POST">
                  ...
                  <div class="form-group">
                    <input class="form-control" id="username" type="text" name="qtEmail" placeholder="Địa chỉ email" autocomplete="off" required=""> 
                  </div>
                  <div class="form-group">
