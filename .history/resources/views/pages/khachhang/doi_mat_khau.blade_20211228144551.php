              ...
              <form action="{{URL::to('/save-thongtin')}}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control" id="inputText3" type="password" name="tenkhachhang" required="" value="{{Session::get('khTen')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputTextarea3">Mật khẩu mới</label>
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control" id="inputText3" type="password" name="sodienthoaikhachhang" required="" value="{{Session::get('khSoDienThoai')}}">
                  </div>
                </div>
