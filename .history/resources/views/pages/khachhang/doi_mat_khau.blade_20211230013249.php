              ...
              <form action="{{URL::to('/save-matkhau')}}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control @error('matkhaucu') is-invalid @enderror" id="inputText3" type="password" name="matkhaucu">
                    @error('matkhaucu')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control @error('matkhaumoi') is-invalid @enderror" id="inputText3" type="password" name="matkhaumoi">
                    @error('matkhaumoi')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
