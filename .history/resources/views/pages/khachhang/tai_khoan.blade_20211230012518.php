            ...
            <div class="card-body">
              ...
              <form action="{{URL::to('/save-thongtin')}}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control @error('shippingTen') is-invalid @enderror" id="inputText3" type="text" name="sodienthoaikhachhang" value="{{Session::get('khSoDienThoai')}}" autocomplete="mobile">
                  </div>
                </div>
