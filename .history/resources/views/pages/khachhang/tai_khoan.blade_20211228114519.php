              ...
              <form action="{{URL::to('/save-loaisanpham')}}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control" id="inputText3" type="text" name="loaisanpham_ten" required="" value="{{Session::get('khTen')}}">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputTextarea3">Số điện thoại</label>
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control" id="inputText3" type="text" name="loaisanpham_ten" required="" value="{{Session::get('khSoDienThoai')}}">
                  </div>
                </div>
                <div class="form-group now">
                  ...
                  <div class="col-6 col-sm-6 col-lg-6">
                    <p class="text-right">
                      <button class="btn btn-space btn-primary" >Cập nhật thông tin</button>
                      <a class="btn btn-space btn-primary" href="*">Đổi mật khẩu</a>
                    </p>
                  </div>
                </div>
              </form>
