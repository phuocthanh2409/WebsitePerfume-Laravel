              ...
              Tiền mặt
					...
					<table class="table table-striped" style="width:100%; border:1px;">
						...
						<tbody>
							...
							@endforeach
							@php
									$total_all = $total + Session::get('phivanchuyen');
							@endphp
							<tr>

								<td colspan="4" style="text-align: center">Tổng tiền thanh toán khi chưa áp dụng mã giảm giá và phí vận chuyển: {{number_format($total_all,0,',','.')}}vnđ</td>
							</tr>
