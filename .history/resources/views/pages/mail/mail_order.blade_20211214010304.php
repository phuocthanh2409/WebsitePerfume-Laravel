...
<body style="background-color:#e2e1e0;font-family: Open Sans, sans-serif;font-size:100%;font-weight:400;line-height:1.4;color:#000;">
  <div class="container" style="background: #beige;border-radius: 12px;padding:15px;">
		<div class="col-md-12" >
			...
			<div class="row">
				...
				<div class="col-md-12">
					<p style="color:#fff;font-size: 17px;">Cửa hàng xin gửi mail thông xin đơn hàng cho bạn</p>
              ...
              Tiền mặt
				...
				<p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="#">Shop</a>, hoặc liên hệ qua số hotline : 0399123123.Xin cảm ơn quý khách đã đặt hàng shop chúng tôi.</p>
