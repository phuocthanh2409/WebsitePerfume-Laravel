            ...
            <tr>
              <td colspan="9" style="text-align: right">
                ...
                <?php
                  ...
                  echo '<h5 style="font-weight: bold" >Giảm giá: '.number_format($total_after_coupon,0,',','.').' VNĐ'.'</h5></br>';
                  $total_coupon = $total - $total_after_coupon + $details->spPhiVanChuyen;
                ?>
                @else 
                  <?php
                  echo '<h5 style="font-weight: bold" >Giảm giá: '.number_format($coupon_number,0,',','.').' VNĐ'.'</h5></br>';
                  $total_coupon = $total - $coupon_number + $details->spPhiVanChuyen; 
                  ?>
                @endif
                <h5 style="font-weight: bold">Phí ship: {{number_format($details->spPhiVanChuyen,0,',','.')}} VNĐ <br></h5>
                <h5 style="font-weight: bold">Thanh toán: {{number_format($total_coupon,0,',','.')}} VNĐ</h5>
              </td>
            </tr>
            {{-- <tr>
              <td colspan="8">
