            ...
            <tr>
              <td colspan="9" style="text-align: right">
                ...
                <?php
                  ...
                  echo '<h6 style="font-weight: bold" >Giảm giá: '.number_format($total_after_coupon,0,',','.').' VNĐ'.'</h6></br>';
                  $total_coupon = $total - $total_after_coupon + $details->spPhiVanChuyen;
                ?>
                @else 
                  <?php
                  echo '<h6 style="font-weight: bold" >Giảm giá: '.number_format($coupon_number,0,',','.').' VNĐ'.'</h6></br>';
