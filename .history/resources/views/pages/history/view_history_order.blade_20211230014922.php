...
<div class="row" style="padding-top: 50px; padding-bottom: 100px; width: 100%; margin-right: 0; margin-left: 0;">
  <h4 style="padding-left: 15px;">Chi tiết đơn hàng</h4>
  @if (session('error'))
        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5" style="text-align: center">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>
                <input type="number" disabled {{$order_status == 2 ? 'disabled' : ''}} class="order_qty_{{$details->spMa}}" min="1" value="{{$details->spSoLuongMua}}" name="product_sales_quantity">
