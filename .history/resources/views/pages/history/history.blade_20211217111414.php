@extends('layout')
@section('content')
<div class="row" style="padding-top: 50px; padding-bottom: 100px; width: 100%;">
  <div class="col-sm-12">
        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>{{$ord->dhNgayDat}}</td>
              <td class="actions" ><a class="icon" href="{{URL::to('/view-donhang/'.$ord->dhCode)}}"><i class="fas fa-file-invoice"></i></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
