                                      ...
                                      <div class="shop__sidebar__price">
                                          <ul>
                                            <li><a href="{{URL::to('/giasanpham-1')}}">< 1.000.000 VNĐ</a></li>
                                              <li><a href="{{URL::to('/giasanpham-1')}}">1.000.000 VNĐ - 2.000.000 VNĐ</a></li>
                                              <li><a href="{{URL::to('/giasanpham-1')}}">2.000.000 VNĐ - 5.000.000 VNĐ</a></li>
                                              <li><a href="{{URL::to('/giasanpham-1')}}">5.000.000 VNĐ - 10.000.000 VNĐ</a></li>
                                              <li><a href="{{URL::to('/giasanpham-1')}}">> 10.000.000 VNĐ</a></li>
                                          </ul>
                                      </div>
                                  </div>
                              </div>
