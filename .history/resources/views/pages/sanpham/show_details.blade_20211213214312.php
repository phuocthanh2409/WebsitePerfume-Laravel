                  ...
                  <div class="product__details__text">
                      ...
                      <form method="POST">
                          {{csrf_field()}}
                            ...
                            <input type="hidden" value="{{$value->spSoLuong}}" class="cart_product_image_{{$value->spMa}}">
                          ...
                          <div class="product__details__cart__option">
                              <div class="quantity">
                                ...
                                <input type="button" class="primary-btn add-to-cart" data-id_product="{{$sp->spMa}}" name="add-to-cart" value="Thêm vào giỏ hàng">
                            </div>
