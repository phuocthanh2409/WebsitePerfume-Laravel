      ...
      <div class="container">
          ...
          <div class="row">
              <div class="col-lg-12 col-md-12">
                <ul id="imageGallery" style="margin: 0 auto;">
                    <li data-thumb="{{asset('public/frontend/img/Miss-Dior-2021-340x340.png')}}" data-src="{{asset('public/frontend/img/Miss-Dior-2021-340x340.png')}}">
                      <img src="{{asset('public/frontend/img/Miss-Dior-2021-340x340.png')}}" />
                    </li>
                    <li data-thumb="{{asset('public/frontend/img/Miss-Dior-2021-parfum-300x315.png')}}" data-src="{{asset('public/frontend/img/Miss-Dior-2021-parfum-300x315.png')}}">
                      <img src="{{asset('public/frontend/img/Miss-Dior-2021-parfum-300x315.png')}}" />
                    </li>
                    <li data-thumb="{{asset('public/frontend/img/Miss-Dior-EDP-2021-300x305.png')}}" data-src="{{asset('public/frontend/img/Miss-Dior-EDP-2021-300x305.png')}}">
                        <img src="{{asset('public/frontend/img/Miss-Dior-EDP-2021-300x305.png')}}" />
                    </li>
                    <li data-thumb="{{asset('public/frontend/img/Nuoc-hoa-Miss-Dior-EDP-2021-300x286.png')}}" data-src="{{asset('public/frontend/img/Nuoc-hoa-Miss-Dior-EDP-2021-300x286.png')}}">
                    <img src="{{asset('public/frontend/img/Nuoc-hoa-Miss-Dior-EDP-2021-300x286.png')}}" />
                    </li>
                </ul>
