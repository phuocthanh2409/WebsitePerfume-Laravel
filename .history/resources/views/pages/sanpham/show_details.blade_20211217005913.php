                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12">
                            <div class="form-group fl_icon">
                                ...
                                <input class="form-input comment-name" type="text" placeholder="Tên của bạn">
                            </div>
                        </div>
                        <div class="col-xs-12" style="width: 100%; margin: 0 15px;">									
                            <div class="form-group">
                                <textarea class="form-input comment-content" name="comment" required="" placeholder="Bình luận của bạn về sản phẩm"></textarea>
                            </div>
                        </div>
                        <button class="btn btn-primary pull-right send-comment" type="button" style="color: white; margin-left: 15px;">Gửi bình luận</button>
                    </div>
                </form>
