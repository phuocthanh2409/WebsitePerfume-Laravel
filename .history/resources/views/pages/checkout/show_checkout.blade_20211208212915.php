                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      ...
                                      <input type="text" name="shippingTen" required>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      <p>Email<span>*</span></p>
                                      <input type="text" name="shippingEmail" required>
                                  </div>
                              </div>
                          </div>
                          <div class="checkout__input">
                              <p>Địa chỉ<span>*</span></p>
                              <input type="text" name="shippingDiaChi" required>
                          </div>
                          <div class="checkout__input">
                              <p>Số điện thoại<span>*</span></p>
                              <input type="number" name="shippingSoDienThoai" required>
                          </div>
                          <div class="checkout__input">
                              <p>Ghi chú đơn hàng</p>
                              <input type="text"
                              placeholder="Ghi chú đơn hàng của bạn" name="dhGhiChu">
                          </div>
                        </div>
