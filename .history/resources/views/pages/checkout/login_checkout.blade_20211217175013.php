      ...
      <div class="row">
        <div class="col-md-5">
          ...
          if($message){
            ...
            echo '<div class="alert alert-danger alert-simple alert-dismissible" style="border: none;-webkit-box-shadow: none; box-shadow: none; font-size: 15px; color: red;">',$error.'</div>';
