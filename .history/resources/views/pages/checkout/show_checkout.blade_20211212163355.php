              ...
              <div class="row">
                  <div class="col-lg-8 col-md-6">
                      ...
                      <h6 class="checkout__title">Thông tin gửi hàng</h6>
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      ...
                                      <input type="text" name="shippingTen" class="shippingTen" required autocomplete="name">
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                          ...
                          <input type="hidden" name="order_coupon" class="shippingSoDienThoai" required autocomplete="mobile">
                          <input type="hidden" name="shippingSoDienThoai" class="shippingSoDienThoai" required autocomplete="mobile">
                        </div>
