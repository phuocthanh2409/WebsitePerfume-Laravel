...
<head>
  ...
  <title>Email kích hoạt tài khoản</title>
</head>
		...
		<div class="col-md-12" >
			...
			<div class="row">
				...
				<div class="col-md-6 logo"  style="color: #000">
					<p style="color:#000;font-size: 17px;>Chào bạn</p>
				</div>
				
				<div class="col-md-12">
					<p style="color:#000;font-size: 17px;">Click vào đây {{$data['body']}} để kích hoạt tài khoản</p>
				</div>
