                  ...
                  <div class="col-lg-8 col-md-6">
                      ...
                      <h6 class="checkout__title">Thông tin gửi hàng</h6>
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      ...
                                      <input type="text" name="shippingTen" class="shippingTen @error('shippingTen') is-invalid @enderror" value="{{Session::get('khTen')}}" autocomplete="name" required>
                                      @error('shippingTen')
                              ...
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      <p>Email<span> *</span></p>
                                      <input type="text" name="shippingEmail" class="shippingEmail @error('shippingEmail') is-invalid @enderror" value="{{Session::get('khEmail')}}" autocomplete="email" required>
                                      @error('shippingEmail')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                  </div>
                          ...
                          <div class="checkout__input">
                              ...
                              <input type="text" name="shippingDiaChi" class="shippingDiaChi @error('shippingDiaChi') is-invalid @enderror" autocomplete="address-level1" required>
                          ...
                          <div class="checkout__input">
                              ...
                              <input type="number" name="shippingSoDienThoai" class="shippingSoDienThoai @error('shippingSoDienThoai') is-invalid @enderror" value="{{Session::get('khSoDienThoai')}}" autocomplete="mobile" required>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <input type="button" value="Đặt hàng" class="site-btn send_order" name="send_order">
                                </div>
                            </div>
                        </div>
          </form>
