          ...
          <form role="form" method="POST" action="{{url('/recover-pass')}}">
           ...
           <fieldset>							
             ...
             <div class="form-group">
               <input type="email" style="width: 30%" name="email_account" class="form-control input-lg class="form-control input-lg @error('email_account') is-invalid @enderror"" placeholder="Địa chỉ email" required>
             </div>
             <div>
