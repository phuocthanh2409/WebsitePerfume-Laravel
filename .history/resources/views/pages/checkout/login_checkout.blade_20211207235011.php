      ...
      <div class="row">
       ...
       <div class="col-md-5">
           ...
           <fieldset>							
             ...
             <div class="form-group">
              <input type="text" name="ten" id="username" class="form-control input-lg" placeholder="Họ và tên">
            </div>
             <div class="form-group">
             ...
             <div class="form-group">
              <input type="password" name="password" id="password" class="form-control input-lg" placeholder="Số điện thoại">
            </div>
             <div>
