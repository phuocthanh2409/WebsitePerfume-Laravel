            ...
            {{csrf_field()}}
                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      ...
                                      <input type="text" name="shippingTen" class="shippingTen @error('email_account') is-invalid @enderror" value="{{Session::get('khTen')}}" required autocomplete="name">
                                      @error('email_account')
              ...
              @enderror
                              ...
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      <p>Email<span> *</span></p>
                                      <input type="text" name="shippingEmail" class="shippingEmail" value="{{Session::get('khEmail')}}" required autocomplete="email">
                                  </div>
                              </div>
                          </div>
                          <div class="checkout__input">
                          ...
                          <div class="checkout__input">
                              ...
                              <input type="number" name="shippingSoDienThoai" class="shippingSoDienThoai" value="{{Session::get('khSoDienThoai')}}" required autocomplete="mobile">
                          </div>
                          <div class="checkout__input">
                              <p>Ghi chú đơn hàng</p>
                              <input type="text" name="shippingGhiChu" class="shippingGhiChu">
                          </div>
