                      ...
                      <h6 class="checkout__title">Thông tin gửi hàng</h6>
                          <div class="row">
                              ...
                              <div class="col-lg-6">
                                  <div class="checkout__input">
                                      <p>Email<span> *</span></p>
                                      <input type="text" name="shippingEmail" class="shippingEmail" value="{{Session::get('khEmaiil')}}" required autocomplete="email">
                                  </div>
                              </div>
                          </div>
                          <div class="checkout__input">
                          ...
                          <div class="checkout__input">
                              ...
                              <input type="number" name="shippingSoDienThoai" class="shippingSoDienThoai" value="{{Session::get('khTen')}}" required autocomplete="mobile">
                          </div>
                          <div class="checkout__input">
