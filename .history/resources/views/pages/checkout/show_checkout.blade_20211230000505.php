                  ...
                  <div class="col-lg-8 col-md-6">
                      ...
                      <h6 class="checkout__title">Thông tin gửi hàng</h6>
                          ...
                          <div class="checkout__input">
                              ...
                              <input type="number" name="shippingSoDienThoai" class="shippingSoDienThoai @error('shippingDiaChi') is-invalid @enderror" value="{{Session::get('khSoDienThoai')}}" required autocomplete="mobile">
                          </div>
                          <div class="checkout__input">
