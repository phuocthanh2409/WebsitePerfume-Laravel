      ...
      <div class="row">
       ...
       <div class="col-md-5">
           ...
           <fieldset>							
             ...
             <div class="form-group">
              <input type="text" name="khTen" class="form-control input-lg" placeholder="Họ và tên">
            </div>
             <div class="form-group">
               <input type="email" name="khEmail" class="form-control input-lg" placeholder="Email">
             </div>
             <div class="form-group">
               <input type="password" name="khMatKhau" class="form-control input-lg" placeholder="Mật khẩu">
             </div>
             <div class="form-group">
              <input type="number" name="khSoDienThoai" class="form-control input-lg" placeholder="Số điện thoại" maxlength="10">
            </div>
             <div>
