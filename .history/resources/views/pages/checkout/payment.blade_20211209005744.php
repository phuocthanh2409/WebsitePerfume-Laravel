                        ...
                        <div class="checkout__order">
                            ...
                            <div class="checkout__input__checkbox">
                                <label for="payment">
                                    ...
                                    <input type="checkbox" class="radio" id="payment" name="payment_option" value="tiền mặt">
                            ...
                            <div class="checkout__input__checkbox">
                                <label for="paypal">
                                    ...
                                    <input type="checkbox" class="radio" id="paypal" name="payment_option" value="thẻ ATM">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
