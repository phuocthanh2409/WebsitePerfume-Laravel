          ...
          <form role="form" method="POST" action="{{URL::to('/login-customer')}}">
           ...
           <fieldset>							
             ...
             <div class="form-group">
               <input type="email" name="khEmail" id="khEmail" class="form-control input-lg @error('khEmail') is-invalid @enderror" placeholder="Địa chỉ email">
               @error('title')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
             </div>
             <div class="form-group">
               <input type="password" name="khMatKhau" id="khMatKhau" class="form-control input-lg @error('khMatKhau') is-invalid @enderror" placeholder="Mật khẩu" required>
             </div>
             <span >
