        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="cart__discount">
                    ...
                    <a href="{{URL::to('/unset-magiamgia')}}" class="primary-btn" style="margin-left: 45px;margin-top: 20px;">Xóa mã khuyến mãi</a>
                    @endif
                </div>
                <div class="cart__discount" >
                ...
                <div class="cart__total">
                    ...
                    <ul>
                        ...
                        @endif
                        <li>Tổng tiền cần thành toán<span>
                        <?php
                    ...
                    ?>
                        ...
                        <?php
                    }elseif($customer_id==NULL & $cart!=NULL ){
                    ?>
