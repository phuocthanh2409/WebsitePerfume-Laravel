        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="cart__discount" style="margin-bottom: 68px;">
                    ...
                    <a href="{{URL::to('/unset-magiamgia')}}" style="color: #ffffff;
                    font-weight: 700;
                    letter-spacing: 2px;
                        ...
                        <div class="form-group now">
                          <div class="col-12 col-sm-8 col-lg-6" style="max-width: 100%">
                            <p class="text-right">
                              ...
                              <input type="button" value="Tính phí vận chuyển" class="primary-btn calculate_delivery" style="color: #ffffff;     margin-left: 45px;">
                            </p>
                          </div>
                        </div>
                    </form>
                    @if(Session::get('phivanchuyen'))
                    <a href="{{URL::to('/del-phivanchuyen')}}" class="primary-btn calculate_delivery">Xóa phí vận chuyển</a>
                    @endif
                </div>
