        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="cart__discount" >
                        ...
                        <div class="form-group now">
                          <div class="col-12 col-sm-8 col-lg-6" style="max-width: 100%">
                            <p class="text-right">
                              ...
                              <input type="button" value="Tính phí vận chuyển" class="primary-btn calculate_delivery" >
                            </p>
                          </div>
                        </div>
                    </form>
                    @if(Session::get('phivanchuyen'))
                    <a href="{{URL::to('/del-phivanchuyen')}}" style="color: #ffffff;
                    font-weight: 700;
                    letter-spacing: 2px;
                    text-transform: uppercase;
                    background: #111111;
                    ...
                    right: 111px;
                    top: 114px;
                    height: 10%;">Xóa phí vận chuyển</a>
                    @endif
                </div>
