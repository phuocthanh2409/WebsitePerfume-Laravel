        ...
        <div class="row">
                          ...
                          @foreach(Session::get('cart') as $key => $cart)
                            ...
                            <tr>
                                ...
                                <td class="quantity__item">
                                    <div class="quantity">
                                        <div class="pro-qty-2">
                                            <input class="cart_quantity" type="number" min="1" name="cart_qty[{{$cart['session_id']}}]" value="{{$cart['product_qty']}}" style="input::-webkit-outer-spin-button,
            ...
            <div class="col-lg-4">
                ...
                <div class="cart__total">
                    ...
                    <a href="{{URL::to('/login-checkout')}}" class="primary-btn">Xác nhận thanh toán</a>
                </div>
            </div>
        </div>
    </div>
