        ...
        <div class="row">
                          ...
                          @foreach(Session::get('cart') as $key => $cart)
                            ...
                            <tr>
                                ...
                                <td class="quantity__item">
                                    <div class="quantity">
                                        <div class="pro-qty-2">
                                            <input type="number" min="1" name="cart_quantity" value="{{$cart['product_qty']}}">
                                        </div>
                                    </div>
                                </td>
            ...
            <div class="col-lg-4">
                ...
                <div class="cart__total">
                    <h6>Tổng giỏ hàng</h6>
                    <ul>
                        <li>Tổng tiền<span> {{number_format($subtotal,0,',','.')}}</span></li>
                        <li>Giá tiền<span></span></li>
                        <li>Tổng giá tiền<span></span></li>
                    </ul>
