                        ...
                        <div class="header__top__right">
                            <div class="header__top__links">
                                ...
                                ?>
                                    ...
                                    <a href="{{url('/history')}}">Thông tin tài khoản</a>
                                    <a href="{{url('/history')}}">Lịch sử đơn hàng</a>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('.send_order').click(function(){
                ...
                text: "Bạn đã điền đầy đủ thông tin và xác nhận đặt hàng",
                type: "warning",
                showCancelButton: true,
                ...
                function(isConfirm){
                    if (isConfirm) {
                        ...
                        swal("Đóng", "Bạn vui lòng kiểm tra đơn hàng và hoàn tất đơn hàng", "error");
                    }
                });
