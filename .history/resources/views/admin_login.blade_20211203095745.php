...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{('public/backend/assets\img\logo-fav.png')}}">
    <title>Beagle</title>
    <link rel="stylesheet" type="text/css" href="{{('public/backend/assets\lib\perfect-scrollbar\css\perfect-scrollbar.css')}}">
    <link rel="stylesheet" type="text/css" href="{{('public/backend/assets\lib\material-design-icons\css\material-design-iconic-font.min.css')}}">
    <link rel="stylesheet" href="{{('public/backend/assets\css\app.css')}}" type="text/css">
  </head>
