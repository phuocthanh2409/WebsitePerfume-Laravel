        ...
        <form action="{{URL::to('/update-sanpham/'.$pro->spMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-6">
              <input name="sanpham_hinhanh" class="inputfile @error('sanpham_soluong') is-invalid @enderror" id="file-1" type="file" name="file-1" data-multiple-caption="{count} files selected" multiple="" value="{{$pro->spHinhAnh}}">
              @error('sanpham_soluong')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
