        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="actions">
                <?php
                  if($cate_pro->loaiTrangThai==1){
                ?>
                  <a href="{{URL::to('/unactive-loaisanpham/'.$cate_pro->loaiMa)}}" class="icon"><span class="mdi mdi-close" style="color:red"></span></a>';
                  <?php 
                  }else{
                  ?>
                  <a href="{{URL::to('/active-loaisanpham/'.$cate_pro->loaiMa)}}" class="icon"><span class="mdi mdi-check" style="color:green"></a>';
                  <?php
                  }
                ?>
              </td>
