        ...
        @if (session('error'))
              ...
              <form action="{{URL::to('/save-adminthongtin')}}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control @error('sodienthoaikhachhang') is-invalid @enderror" id="inputText3" type="text" name="sodienthoaikhachhang" value="{{Session::get('qtSoDienThoai')}}" autocomplete="mobile">
