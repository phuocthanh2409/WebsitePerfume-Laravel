    ...
    <div class="card card-table">
      ...
      <div class="card-body">
        @if (session('error'))
                ...
                @endif
              <form action="{{URL::to('/save-adminthongtin')}}" method="POST">
                {{ csrf_field() }}
                <div class="form-group row">
                  <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Họ và tên</label>
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control @error('tenkhachhang') is-invalid @enderror" id="inputText3" type="text" name="tenkhachhang" value="{{Session::get('qtTen')}}" autocomplete="name">
                    @error('tenkhachhang')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control @error('sodienthoaikhachhang') is-invalid @enderror" id="inputText3" type="text" name="sodienthoaikhachhang" value="{{Session::get('khSoDienThoai')}}" autocomplete="mobile">
                    @error('sodienthoaikhachhang')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                </div>
