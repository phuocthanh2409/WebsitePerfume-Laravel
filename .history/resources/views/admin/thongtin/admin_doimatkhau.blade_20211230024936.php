        ...
        @if (session('error'))
              ...
              <form action="{{URL::to('/save-matkhauquantri')}}" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-sm-8 col-lg-6">
                    <input class="form-control @error('quantrimatkhaumoi') is-invalid @enderror" id="inputText3" type="password" name="quantrimatkhaumoi" value="{{Session::get('qtSoDienThoai')}}">
