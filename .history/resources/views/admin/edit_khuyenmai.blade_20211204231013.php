          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-7 col-md-5 col-lg-4 col-xl-3">
              <div class="input-group date datetimepicker" data-min-view="2" data-date-format="dd-mm-yyyy">
                <input class="form-control" size="16" type="text" value="{{$edit_value->kmNgayBatDau}}" placeholder="dd-mm-yyyy" name="khuyenmai_ngaybatdau" required>
