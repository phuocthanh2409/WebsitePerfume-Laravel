      ...
      <div class="card-body">
        <form action="{{URL::to('/save-phieunhap')}}" method="POST">
          ...
          <div class="form-group row">
            <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Nhà cung cấp</label>
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control" id="inputText3" type="text" placeholder="Tên nhà cung cấp" name="phieunhap_tennhacungcacp" required="">
            </div>
          </div>
          <div class="form-group row">
