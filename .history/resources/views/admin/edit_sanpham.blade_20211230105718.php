      ...
      <div class="card-body">
        ...
        <form action="{{URL::to('/update-sanpham/'.$pro->spMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format @error('sanpham_gia') is-invalid @enderror" data-parsley-type="length" type="text" required="" value="{{$pro->spGiaGoc}}" name="sanpham_giagoc">
            </div>
          </div>
