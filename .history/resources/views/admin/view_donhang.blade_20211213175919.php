        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>
                <input type="number" class="order_qty_{{$details->spMa}}" min="1" value="{{$details->spSoLuongMua}}" name="product_sales_quantity">
                <input type="hidden" name="order_product_id" data-product_id="{{$details->spMa}}" class="order_product_id" value="{{$details->spMa}}" >
                <button class="btn btn-default update_quantity_order" name="update_quantity_order">Cập nhật</button>
              </td>
