                ...
                @foreach($order as $key => $or)
                  @if($or->dhTrangThai == 1)
                    <form>
                      ...
                      <select class="form-control order_details">
                        ...
                        <option value="{{$or->dhMa}}">Chưa xử lý</option>
                        <option value="{{$or->dhMa}}">Đã xử lý - Đã giao hàng</option>
                        <option value="{{$or->dhMa}}">Hủy đơn hàng - Tạm giữ</option>
                      </select>
                    </form>
                  @elseif($or->dhTrangThai == 2)
                    <form>
                      ...
                      <select class="form-control order_details">
                        <option value="">-- Chọn hình thức đơn hàng --</option>
                        <option value="{{$or->dhMa}}">Chưa xử lý</option>
                        <option value="{{$or->dhMa}}" selected>Đã xử lý - Đã giao hàng</option>
                        <option value="{{$or->dhMa}}">Hủy đơn hàng - Tạm giữ</option>
                      </select>
                    </form>
                  @else 
                  <form>
                    ...
                    <select class="form-control order_details">
                      ...
                      <option value="{{$or->dhMa}}">Chưa xử lý</option>
                      <option value="{{$or->dhMa}}">Đã xử lý - Đã giao hàng</option>
                      <option value="{{$or->dhMa}}" selected>Hủy đơn hàng - Tạm giữ</option>
                    </select>
                  </form>
                  @endif
                @endforeach
