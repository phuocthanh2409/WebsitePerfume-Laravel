      ...
      <div class="card-body">
        <table class="table">
          ...
          <tbody>
            <tr>
              <td>{{$khachhang}}</td>
              <td>{{$order_by_id[0]->khTen}}</td>
              <td>{{$order_by_id[0]->khSoDienThoai}}</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="card card-table">
      ...
      <div class="card-body">
        <table class="table">
          ...
          <tbody>
            <tr>
              <td>{{$order_by_id[0]->shippingTen}}</td>
              <td>{{$order_by_id[0]->shippingDiaChi}}</td>
              <td>{{$order_by_id[0]->shippingSoDienThoai}}</td>
            </tr>
          </tbody>
        </table>
      </div>
