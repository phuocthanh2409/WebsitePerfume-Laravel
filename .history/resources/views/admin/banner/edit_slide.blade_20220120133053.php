        ...
        <form action="{{URL::to('/update-banner/'.$banner->sliderMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control  @error('slider_ten') is-invalid @enderror" id="inputText3" type="text" value="{{$banner->sliderTen}}" name="banner_ten" required="">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-12 col-sm-3 col-form-label text-sm-right" for="file-1">Hình ảnh banner</label>
            <div class="col-12 col-sm-6">
              <input name="banner_hinhanh" class="inputfile" id="file-1" type="file" name="file-1" data-multiple-caption="{count} files selected" multiple="">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control" id="editor" name="banner_mota" required="">{{$banner->sliderMoTa}}</textarea>
            </div>
          </div>
