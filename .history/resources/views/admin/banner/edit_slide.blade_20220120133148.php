        ...
        <form action="{{URL::to('/update-banner/'.$banner->sliderMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-6">
              <input name="banner_hinhanh" class="inputfile @error('banner_ten') is-invalid @enderror" id="file-1" type="file" name="file-1" data-multiple-caption="{count} files selected" multiple="">
