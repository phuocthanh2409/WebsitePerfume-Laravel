        ...
        <form action="{{URL::to('/update-info/'.$val->ttMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control @error('info_contact') is-invalid @enderror" placeholder="Thông tin liên hệ" id="editor" name="info_contact" required="">{{$val->ttLienHe}}</textarea>
              @error('info_contact')
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control" placeholder="Link bản đồ Google" name="info_map" required="">{{$val->ttMap}}</textarea>
            </div>
          </div>
          <div class="form-group row">
