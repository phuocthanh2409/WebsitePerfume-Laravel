        ...
        <form action="{{URL::to('/update-info/'.$val->ttMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-6">
              <input name="info_image" class="inputfile @error('info_image') is-invalid @enderror" id="file-1" type="file" name="file-1" data-multiple-caption="{count} files selected" multiple="">
              @error('info_image')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
