        ...
        <form action="{{URL::to('/update-info/'.$val->ttMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control @error('khEmaildk') is-invalid @enderror" placeholder="Thông tin liên hệ" id="editor" name="info_contact" required="">{{$val->ttLienHe}}</textarea>
              @error('khEmaildk')
