...
<html lang="en">
  ...
  <body>
    ...
    <script src="{{('public/backend/assets\lib\jquery\jquery.min.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\perfect-scrollbar\js\perfect-scrollbar.min.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\bootstrap\dist\js\bootstrap.bundle.min.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\js\app.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\jquery-ui\jquery-ui.min.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\jquery.nestable\jquery.nestable.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\moment.js\min\moment.min.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\datetimepicker\js\bootstrap-datetimepicker.min.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\select2\js\select2.min.js')}}" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\select2\js\select2.full.min.js')}}" type="text/javascript"></script>
    <script src="assets\lib\bootstrap-slider\bootstrap-slider.min.js" type="text/javascript"></script>
    <script src="{{('public/backend/assets\lib\bs-custom-file-input\bs-custom-file-input.js')}}" type="text/javascript"></script>
