      ...
      <div class="card-body">
        <form action="{{URL::to('/insert-magiamgia-code')}}" method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control" type="text" placeholder="Mã giảm giá" name="magiamgia_Code">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-12 col-sm-3 col-form-label text-sm-right" >Số lượng mã giảm giá</label>
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control" type="number" placeholder="Số lượng mã giảm giá" name="magiamgia_SoLuong">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control" type="number" placeholder="Nhập % giảm hoặc tiền giảm" name="magiamgia_GiaTri">
            </div>
          </div>
