      ...
      <div class="card-body">
        <form action="{{URL::to('/insert-magiamgia-code')}}" method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control @error('mggCode') is-invalid @enderror" type="text" placeholder="Mã giảm giá" name="mggCode">
              @error('mggCode')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control @error('magiamgia_GiaTri') is-invalid @enderror" type="number" placeholder="Nhập % giảm hoặc tiền giảm" name="magiamgia_GiaTri">
