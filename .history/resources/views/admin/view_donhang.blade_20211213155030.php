        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>
                <input type="number" min="1" value="{{$details->spSoLuongMua}}" name="product_sales_quantity">
                <input type="hidden" name="order_checkout_quantity" class="order_checkout_quantity" value="{{$details->spMa}}" >
