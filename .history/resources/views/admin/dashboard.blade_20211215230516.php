...
<div class="container-fluid">
    ...
    <div >
        ...
        <form autocomplete="off">
            @csrf
            <div class="col-md-2">
                <p>Từ ngày: <input type="text" id="datepicker" class="form-control datetimepicker" class="form-control input-group date datetimepicker" data-min-view="2" data-date-format="yyyy-mm-dd"></p>
