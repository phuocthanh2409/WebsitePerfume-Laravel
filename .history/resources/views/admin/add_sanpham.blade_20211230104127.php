      ...
      <div class="card-body">
        <form action="{{URL::to('/save-sanpham')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format @error('sanpham_gia') is-invalid @enderror" data-parsley-type="length" type="text" placeholder="Giá bán sản phẩm" name="sanpham_gia">
              @error('sanpham_gia')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format @error('sanpham_giagoc') is-invalid @enderror" data-parsley-type="length" type="text" placeholder="Giá gốc sản phẩm" name="sanpham_giagoc">
