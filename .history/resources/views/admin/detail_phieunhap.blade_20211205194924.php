        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td>{{$pn_pro->spTen}}</td>
              <td>{{$pn_pro->spGia}}</td>
              <td>{{$pn_pro->spDungTich}}</td>
              <td>{{$pn_pro->spHinhAnh}}</td>
              <td class="actions"><a class="icon" href="{{URL::to('/edit-detailphieunhap/'.$pn_pro->pnMa)}}"><i class="mdi mdi-edit"></i></a></td>
              <td class="actions"><a class="icon" onclick="return confirm('Bạn có chắc là muốn xóa ?')" href="{{URL::to('/delete-detailphieunhap/'.$pn_pro->pnMa)}}"><i class="mdi mdi-delete"></i></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
