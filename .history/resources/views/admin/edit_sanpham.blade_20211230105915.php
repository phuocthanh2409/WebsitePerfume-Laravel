      ...
      <div class="card-body">
        ...
        <form action="{{URL::to('/update-sanpham/'.$pro->spMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format @error('sanpham_giagoc') is-invalid @enderror" data-parsley-type="length" type="text" required="" value="{{$pro->spGiaGoc}}" name="sanpham_giagoc">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control @error('sanpham_mota') is-invalid @enderror" id="editor" name="sanpham_mota" required="">{{$pro->spMoTa}}</textarea>
              @error('sanpham_mota')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-6">
              <input name="sanpham_hinhanh" class="inputfile @error('sanpham_hinhanh') is-invalid @enderror" id="file-1" type="file" name="file-1" data-multiple-caption="{count} files selected" multiple="" value="{{$pro->spHinhAnh}}">
