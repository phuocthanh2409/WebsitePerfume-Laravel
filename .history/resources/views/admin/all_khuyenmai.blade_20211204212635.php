        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="actions" ><a class="icon" href="{{URL::to('/edit-khuyenmai/'.$cate_pro->loaiMa)}}"><i class="mdi mdi-edit"></i></a></td>
              <td class="actions"><a class="icon" onclick="return confirm('Bạn có chắc là muốn xóa ?')" href="{{URL::to('/delete-khuyenmai/'.$cate_pro->loaiMa)}}"><i class="mdi mdi-delete"></i></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
