          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="actions">
                ...
                ?>
                  <a href="{{URL::to('/unactive-loaisanpham/'.$cate_pro->loaiMa)}}" class="icon"><span class="mdi mdi-check" style="color:red"></span></a>';
                  <?php 
                  }else{
                  ?>
                  <a href="{{URL::to('/active-loaisanpham/'.$cate_pro->loaiMa)}}" class="icon"><span class="mdi mdi-close" style="color:green"></a>';
                  <?php
                  }
                ?>
              </td>
