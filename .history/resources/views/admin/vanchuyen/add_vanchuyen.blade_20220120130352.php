      ...
      <div class="card-body">
        <form action="" method="POST">
          ...
          <div class="form-group row pt-1">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <select class="form-control quanhuyen" name="maqh" id="quanhuyen" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control phivanchuyen" id="phivanchuyen" type="number" placeholder="Phí vận chuyển" name="phivanchuyen">
            </div>
          </div>
