        ...
        <table class="table table-striped table-hover table-fw-widget" id="table5">
          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              ...
              <td class="actions"><a class="icon tooltip" href="{{URL::to('/edit-muasanpham/'.$pn_pro->pnMa)}}"><i class="mdi mdi-edit"><span class="tooltiptext">Xem chi tiết phiếu nhập</span></i></a></td>
