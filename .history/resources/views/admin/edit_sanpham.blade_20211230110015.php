        ...
        <form action="{{URL::to('/update-sanpham/'.$pro->spMa)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control @error('sanpham_ten') is-invalid @enderror" id="inputText3" type="text" value="{{$pro->spTen}}" name="sanpham_ten">
              @error('sanpham_ten')
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format @error('sanpham_gia') is-invalid @enderror" data-parsley-type="length" type="text" value="{{$pro->spGia}}" name="sanpham_gia">
              @error('sanpham_gia')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format @error('sanpham_giagoc') is-invalid @enderror" data-parsley-type="length" type="text" value="{{$pro->spGiaGoc}}" name="sanpham_giagoc">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control @error('sanpham_mota') is-invalid @enderror" id="editor" name="sanpham_mota">{{$pro->spMoTa}}</textarea>
              @error('sanpham_mota')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
