          ...
          <tbody>
            ...
            <tr class="odd gradeX">
              <td>
                ...
                <input type="button" data-comment_id ="{{$com->blMa}}" id="{{$com->spMa}}" class="btn btn-primary btn-xs comment_status_btn" value="Duyệt" >
                @else
                <input type="button" data-comment_id ="{{$com->blMa}}" id="{{$com->spMa}}" class="btn btn-danger btn-xs comment_status_btn" value="Bỏ duyệt" >
                @endif
              </td>
              <td>{{$com->blTen}}</td>
              <td>{{$com->blNoiDung}}</td>
