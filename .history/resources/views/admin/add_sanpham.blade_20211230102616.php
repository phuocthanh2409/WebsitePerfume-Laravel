      ...
      <div class="card-body">
        <form action="{{URL::to('/save-sanpham')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control @error('sanpham_mota') is-invalid @enderror" id="editor" placeholder="Mô tả sản phẩm" name="sanpham_mota"></textarea>
              @error('sanpham_mota')
                    <div class="alert alert-danger">{{ $message }}</div>
              @enderror
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-6">
              <input name="sanpham_hinhanh" class="inputfile @error('sanpham_soluong') is-invalid @enderror"" id="file-1" type="file" name="file-1" data-multiple-caption="{count} files selected" multiple="">
