        ...
        <form action="{{URL::to('/save-thuonghieu')}}" method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control @error('thuonghieu_ten') is-invalid @enderror" id="inputText3" type="text" placeholder="Tên thương hiệu" name="thuonghieu_ten">
              @error('thuonghieu_ten')
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <textarea rows="10" class="form-control @error('thuonghieu_ten') is-invalid @enderror" placeholder="Mô tả thương hiệu" name="thuonghieu_mota" required=""></textarea>
            </div>
          </div>
