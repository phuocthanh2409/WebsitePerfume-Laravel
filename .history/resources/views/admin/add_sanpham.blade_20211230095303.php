        ...
        <form action="{{URL::to('/save-sanpham')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control @error('info_map') is-invalid @enderror" id="inputText3" type="text" placeholder="Tên sản phẩm" name="sanpham_ten" required="">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-12 col-sm-3 col-form-label text-sm-right">Giá bán sản phẩm</label>
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format" data-parsley-type="length" type="text" required="" placeholder="Giá bán sản phẩm" name="sanpham_gia">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-12 col-sm-3 col-form-label text-sm-right">Giá gốc sản phẩm</label>
            <div class="col-12 col-sm-8 col-lg-6">
              <input class="form-control price_format" data-parsley-type="length" type="text" required="" placeholder="Giá gốc sản phẩm" name="sanpham_giagoc">
            </div>
          </div>
